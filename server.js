...
function botCardPlan(room,p){
  ...
  if(incoming){
    const counters=hand.filter(c=>c.counter),defenses=p.buffs.weakness?[]:hand.filter(c=>c.type==='defense');let card=null;
